    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnAddTransaction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(type.length() == 0){
                    Toast.makeText(AddTransactionActivity.this, "Selecte transaction type", Toast.LENGTH_SHORT).show();
                }
                ...
                fStore.collection("Expenses").document(firebaseAuth.getUid()).collection("note").document(id)
                        .set(transaction)
