    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
           ...
           holder.itemView.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View v) {
                   ...
                   intent.putExtra("amount",transactionModelArrayList.get(position).getId());
                   intent.putExtra("note",transactionModelArrayList.get(position).getId());
                   intent.putExtra("type",transactionModelArrayList.get(position).getId());
